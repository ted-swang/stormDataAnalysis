...
FogFactors <- c("DENSE FOG", "FOG")

##factor names for rip current related factors.
RipCurrentFactors <- c("RIP CURRENT", "RIP CURRENTS")
...
stormData$EVTYPE <- stormData$EVTYPE %>%
        fct_collapse(
                ...
                COLD = ColdFactors,
                FOG = FogFactors, 
                RIPCURRENT = RipCurrentFactors
                     ) %>%
        fct_other(keep = c("TORNADO", "TSTORM", "HEAT", "FLOOD", "WINTERSTORM", "WIND", "TROPSTORM", "FIRE", "HAIL", "FOG", "RIPCURRENT", "COLD"), other_level = "OTHER")
...
popHealthFull$EVTYPE <- popHealthFull$EVTYPE %>% 
        fct_drop %>%
        fct_relevel(c("TORNADO", "TSTORM", "HEAT", "FLOOD", "WINTERSTORM", "WIND", "TROPSTORM", "FIRE", "HAIL", "FOG", "RIPCURRENT", "COLD", "OTHER"))
